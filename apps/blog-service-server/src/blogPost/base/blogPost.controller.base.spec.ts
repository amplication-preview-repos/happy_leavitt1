...
const CREATE_INPUT = {
  ...
  authorUser: "exampleAuthorUser",
  content: "exampleContent",
  contentBlogPost: "exampleContentBlogPost",
  createdAt: new Date(),
  id: "exampleId",
  publishedDate: new Date(),
  publishedDateBlogPost: new Date(),
  title: "exampleTitle",
  titleBlogPost: "exampleTitleBlogPost",
  updatedAt: new Date(),
};
const CREATE_RESULT = {
  author: "exampleAuthor",
  ...
  test("POST /blogPosts", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        publishedDateBlogPost:
          CREATE_RESULT.publishedDateBlogPost.toISOString(),
      ...
      .expect([
        {
          ...
          publishedDateBlogPost:
            FIND_MANY_RESULT[0].publishedDateBlogPost.toISOString(),
  ...
  test("GET /blogPosts/:id existing", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        publishedDateBlogPost:
          FIND_ONE_RESULT.publishedDateBlogPost.toISOString(),
