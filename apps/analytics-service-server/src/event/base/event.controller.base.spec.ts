  ...
  test("POST /events", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        timestampEvent: CREATE_RESULT.timestampEvent.toISOString(),
      ...
      .expect([
        {
          ...
          timestampEvent: FIND_MANY_RESULT[0].timestampEvent.toISOString(),
  ...
  test("GET /events/:id existing", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        timestampEvent: FIND_ONE_RESULT.timestampEvent.toISOString(),
